...
- `script_example`: A string. The download link for a script example of using said plugin.
- `description`: A string.
- `download_link`: A string.
- `download_hash`: A string. The download hash for the plugin.
- `script_download_hash`: A string. The download hash for the script example.
- `source`: A string.
